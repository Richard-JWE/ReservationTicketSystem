					...
					for (x = 1; x == 1;) {
						...
						// if CHOICE is "2" proceed to Ticket Booking//
							...
							// inputing of Passenger's Name//
								...
								for (x = 1; x == 1;) {
									...
									for (int l = 0; l < z; l++) {
										if (ticketS[l][0].equalsIgnoreCase(ticketS[z][0])) {
											System.out.println("Sorry, Passenger has already booked!");
											x = 1;
										}
									}
								}
								...
								String dest[] = { " ", "DUBLIN", "CLIFFS OF MOHER", "CORK", "ARAN ISLANDS",
										"LIMERICK" };
								...
								if (print == 1) {
									...
									System.out.println("FARE PRICE: EUR " + ticketD[z][0]);
							...
							for (x = 1; x == 1;) {
								...
								for (int b = 0; b < z; b++) {
									if (search.equalsIgnoreCase(ticketS[b][0])) {
										...
										System.out.println("FARE PRICE: EUR" + ticketD[b][0]);
										...
										if (ticketS[b][2].equals("x")) {
											...
											for (x = 1; x == 1;) {
												System.out.println("\nPASSENGER'S TOTAL FARE:  EUR" + ticketD[b][2]);
												...
												if (change[b] < 0) {
													...
													System.out.println("CHANGE: EUR " + change[b]);
													System.out.println("");
													x = 0;
												}
											}
